...
2. **Preserve source material**:
   ...
   - Preserve the page's headings, sections, structured data, important tables, artifact markers, examples, and source links from the fetched Markdown in your final `contentMarkdown`
   - Do not omit key numbers, comparison matrices, example text, code blocks, lists, or tables when they are central to the page
   - Follow the source page's information structure as closely as Markdown allows
   ...
   - When fetched Markdown contains `[[artifact:id]]`, keep useful markers at the position where that media belongs
